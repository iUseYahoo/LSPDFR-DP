...
namespace ManiacCallouts.Event
{
	...
	internal class DrunkPerson : EventBasePed
	{
		...
		public override void Action()
		{
			...
			try
			{
				...
				if (flag)
				{
					Game.LogTrivial("[ManiacEvents]Drunk Ped Event Started");
					this.Ped.SetMovementAnimationSet(DrunkPerson._drunkAnimationSets.GetRandomElement(false));
