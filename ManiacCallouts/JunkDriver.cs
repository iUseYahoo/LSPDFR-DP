...
namespace ManiacCallouts.Event
{
	...
	internal class JunkDriver : EventBaseTraffic
	{
		...
		public override void Action()
		{
			...
			try
			{
				...
				if (flag)
				{
					Game.LogTrivial("[ManiacEvents]Junk Car Event Started");
					this.car = this.Ped.CurrentVehicle;
					this.car.IsPersistent = true;
					this.car.EngineHealth = 2f;
					this.car.TopSpeed = 5f;
					this.Ped.Tasks.CruiseWithVehicle(this.car, 2f, 183);
				}
			}
