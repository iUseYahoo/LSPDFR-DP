...
namespace CheckYourAmmo.Essential
{
	...
	internal static class UpdateChecker
	{
		...
		internal static bool Initialize()
		{
			...
			Uri address = new Uri("https://www.lcpdfr.com/applications/downloadsng/interface/api.php?do=checkForUpdates&fileId=40983&textOnly=1");
			try
			{
			...
			Game.DisplayNotification("commonmenu", "shop_box_tick", Helper.assemblyName, "~g~v" + UpdateChecker.LocalVersion + " ~c~by Faya", string.Format("Hold ~b~{0}~s~ to count your ammo.", Settings.HoldToCheckKey));
